...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:6%">
        <div class="row">
            <div class="col-lg-12">
                <asp:Image ID="imgBus" ImageAlign="AbsMiddle" ImageUrl="~/img/page cover.png" style="width:100%" runat="server" />
            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="font-size:large">
                           <ul>
                               ...
                               <li>
                                   Book bus tickets online for Major routes across Sri Lanka.
                               </li>
                           </ul>
